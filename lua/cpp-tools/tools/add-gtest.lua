...
function M.run()
	...
	-- 4. Ask the user for the test module name (overridable for testing)
	local module_qualified = config.customisations.add_gtest.prompt_module_name_fn(default_module_name)
